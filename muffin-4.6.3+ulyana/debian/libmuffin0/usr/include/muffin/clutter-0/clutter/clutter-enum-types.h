...
CLUTTER_AVAILABLE_IN_ALL GType clutter_virtual_device_type_get_type (void) G_GNUC_CONST;
...
CLUTTER_AVAILABLE_IN_ALL GType clutter_keyboard_a11y_flags_get_type (void) G_GNUC_CONST;
...
CLUTTER_AVAILABLE_IN_ALL GType clutter_input_device_tool_type_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_INPUT_DEVICE_TOOL_TYPE (clutter_input_device_tool_type_get_type())
CLUTTER_AVAILABLE_IN_ALL GType clutter_input_device_pad_source_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_INPUT_DEVICE_PAD_SOURCE (clutter_input_device_pad_source_get_type())
CLUTTER_AVAILABLE_IN_ALL GType clutter_input_device_mapping_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_INPUT_DEVICE_MAPPING (clutter_input_device_mapping_get_type())
CLUTTER_AVAILABLE_IN_ALL GType clutter_input_content_hint_flags_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_INPUT_CONTENT_HINT_FLAGS (clutter_input_content_hint_flags_get_type())
CLUTTER_AVAILABLE_IN_ALL GType clutter_input_content_purpose_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_INPUT_CONTENT_PURPOSE (clutter_input_content_purpose_get_type())
CLUTTER_AVAILABLE_IN_ALL GType clutter_input_panel_state_get_type (void) G_GNUC_CONST;
...
CLUTTER_AVAILABLE_IN_ALL GType clutter_button_state_get_type (void) G_GNUC_CONST;
#define CLUTTER_TYPE_BUTTON_STATE (clutter_button_state_get_type())
CLUTTER_AVAILABLE_IN_ALL GType clutter_key_state_get_type (void) G_GNUC_CONST;
