...
static MetaShadowClassInfo default_shadow_classes[] = {
  { "normal",       { 36, -1, 0, 3, 255 }, { 24, -1, 0, 3, 128 } },
  { "dialog",       { 36, -1, 0, 3, 255 }, { 24, -1, 0, 3, 128 } },
  { "modal_dialog", { 36, -1, 0, 1, 255 }, { 24, -1, 0, 3, 128 } },
  { "utility",      { 18, -1, 0, 1, 255 }, { 18, -1, 0, 1, 128 } },
  { "border",       { 36, -1, 0, 3, 255 }, { 24, -1, 0, 3, 128 } },
  { "menu",         { 36, -1, 0, 3, 255 }, { 24, -1, 0, 0, 128 } },

  { "popup-menu",    { 6, -1, 0, 1, 128 }, { 6, -1, 0, 1, 128 } },

  { "dropdown-menu", { 6, 10, 0, 1, 128 }, { 6, 10, 0, 1, 128 } },
  { "attached",      { 36, -1, 0, 1, 255 }, { 24, -1, 0, 3, 128 } }
};
